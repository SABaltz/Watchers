...
function NavBar() {
	var text = React.useContext(ProjectContext);
			...
			React.createElement(Toolbar$1, {disableGutters: true},
				...
				React.createElement(Box$1, {sx: {flexGrow: 1, display: {xs: 'flex', md: 'none'}}},
					...
					React.createElement(Menu$2, {
						...
						return (React.createElement(MenuItem$1, {key: page, onClick: handleCloseNavMenu},
		...
		React.createElement("form", {onSubmit: onSubmit},
			...
			React.createElement("div", {className: "form-group"},
				...
				React.createElement("input", {
					...
					value: form.location,
					onChange: function (e) {
						return updateForm({location: e.target.value});
					}
				})),
			React.createElement("div", {className: "form-group"},
				...
				React.createElement("input", {
					...
					value: form.practice,
					onChange: function (e) {
						return updateForm({practice: e.target.value});
					}
				})),
			React.createElement("div", {className: "form-group"},
				...
				React.createElement("input", {
					...
					onChange: function (e) {
						return updateForm({complaint: e.target.value});
					}
				})),
			React.createElement("div", {className: "form-group"},
				React.createElement("input", {
...
function Application(_a) {
	...
	return (React.createElement(React.Fragment, null,
		React.createElement(ProjectContext.Provider, {value: projectName},
